...
pub fn define() -> WorkflowSpec {
    workflow("lightflow.mask.compose")
        ...
        .input_description("mask_b_path", "Second PNG mask path. It is resized to the first mask dimensions when needed.")
        .input_required("mask_b_path", true)
        .input_widget("mask_b_path", "image")
        .input_artifact_kind("mask_b_path", "mask")
        .input("mode", "text")
        .input_description("mode", "Composition mode: max, add, multiply, min, subtract, union, or intersect.")
        .input_required("mode", false)
        .input_default_json("mode", "\"max\"")
        .input_enum_json("mode", "[\"max\",\"add\",\"multiply\",\"min\",\"subtract\",\"union\",\"intersect\"]")
