...
export async function generateMetadata(props) {
  ...
  return {
    ...
    description: isZh
      ? 'LightFlow 的快速开始、工作流开发、Cargo 共享、扁平布局、架构与发布文档。'
      : 'Quick start, workflow development, Cargo sharing, flat layout, architecture, and publishing documentation for LightFlow.'
  }
}
